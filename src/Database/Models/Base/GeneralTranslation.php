...
class GeneralTranslation extends Entity
{
  ...
  #[ORM\Column(name: 'lang', nullable: false, unique: true, type: 'string'), PROM\PromModelColumn(title: 'Language', type: 'string', editable: false, hide: false, localized: false)]
  protected ?string $lang;
  
  #[ORM\Column(name: 'key', nullable: false, unique: true, type: 'string'), PROM\PromModelColumn(title: 'Key', type: 'string', editable: false, hide: false, localized: false)]
