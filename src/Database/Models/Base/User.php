...
class User extends Entity
{
  ...
  #[ORM\Column(name: 'avatar_id', nullable: true, unique: false, type: 'integer'), PROM\PromModelColumn(title: 'Avatar', type: 'relationship', editable: false, hide: false, localized: false)]
