...
class File extends Entity
{
    ...
    #[ORM\Column(name: 'private', nullable: true, unique: true, type: 'boolean'), PROM\PromModelColumn(title: 'Private', type: 'boolean', editable: false, hide: false, localized: false)]
