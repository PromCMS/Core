...
/**
 * Base class that represents a row from the 'prom__user_roles' table.
 *
 *
 *
...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\PromCMS\\Core\\Models\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of PromCMS\Core\Models\Base\UserRole object.
     */
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[UserRoleTableMap::COL_LABEL] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[UserRoleTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setPermissions($v)
    {
        if ($this->permissions_unserialized !== $v) {
            ...
            $this->modifiedColumns[UserRoleTableMap::COL_PERMISSIONS] = true;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[UserRoleTableMap::COL_SLUG] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserRoleTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserRoleTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserRoleTableMap::translateFieldName('Slug', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PromCMS\\Core\\Models\\UserRole'), 0, $e);
        }
    }
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($this->isColumnModified(UserRoleTableMap::COL_SLUG) && $this->getSlug()) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(UserRoleTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_PERMISSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'permissions';
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_SLUG)) {
            $modifiedColumns[':p' . $index++]  = 'slug';
        }

        $sql = sprintf(
            'INSERT INTO prom__user_roles (%s) VALUES (%s)',
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UserRoleTableMap::COL_LABEL)) {
            $criteria->add(UserRoleTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_DESCRIPTION)) {
            $criteria->add(UserRoleTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_PERMISSIONS)) {
            $criteria->add(UserRoleTableMap::COL_PERMISSIONS, $this->permissions);
        }
        if ($this->isColumnModified(UserRoleTableMap::COL_SLUG)) {
            $criteria->add(UserRoleTableMap::COL_SLUG, $this->slug);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \PromCMS\Core\Models\UserRole (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PromCMS\Core\Models\UserRole Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initUsers(bool $overrideExisting = true): void
    {
        ...
        $this->collUsers->setModel('\PromCMS\Core\Models\User');
    }
        ...
        if (null === $this->collUsers || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collUsers) {
                    ...
                    $collUsers->setModel('\PromCMS\Core\Models\User');
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildUser}> List of ChildUser objects
     */
    public function getUsersJoinFileRelatedByAvatarId(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserQuery::create(null, $criteria);
        $query->joinWith('FileRelatedByAvatarId', $joinBehavior);
    ...
    protected function makeSlugUnique(string $slug, string $separator = '-', bool $alreadyExists = false)
    {
        if (!$alreadyExists) {
            ...
            $count = \PromCMS\Core\Models\UserRoleQuery::create()
        ...
        $query = \PromCMS\Core\Models\UserRoleQuery::create('q')
    ...
    private static $promCmsMetadata = [
      'adminMetadata' => ['icon' => "UserExclamation",],'ignoreSeeding' => false,
      /** @deprec */
      'icon' => 'UserExclamation',
      /** @deprec */
      'admin' => ['icon' => "UserExclamation",],
      'tableName' => (UserRole::TABLE_MAP)::TABLE_NAME,
      'hasTimestamps' => false,
      'hasSoftDelete' => false,
      'columns' => ['id' => ['editable' => false,'hide' => false,'title' => "ID",'type' => "number",'required' => true,'unique' => false,'translations' => false,'autoIncrement' => true,],'label' => ['editable' => true,'hide' => false,'title' => "Label",'type' => "string",'required' => true,'unique' => false,'translations' => false,'autoIncrement' => false,],'description' => ['editable' => true,'hide' => false,'title' => "Description",'type' => "string",'required' => false,'unique' => false,'translations' => false,'autoIncrement' => false,],'permissions' => ['editable' => true,'hide' => false,'title' => "Permissions",'type' => "json",'required' => false,'unique' => false,'translations' => false,'autoIncrement' => false,],'slug' => ['required' => false,'unique' => false,'translations' => false,'autoIncrement' => false,],],
      'hasOrdering' => false,
      'isDraftable' => false,
      'isSharable' => false,
      'ownable' => false,
    ...
    {
      return str_contains((UserRole::TABLE_MAP)::TABLE_NAME, 'singleton_');
    }
    /**
