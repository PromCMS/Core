...
#[ORM\Entity, ORM\Table(name: '<?php echo $entity->getTranslationTableName() ?>'), ORM\UniqueConstraint(name: 'lookup_unique_idx', columns: ['locale', 'object_id', 'field']), ORM\HasLifecycleCallbacks]
